...
export default {
      setup() {
            ...
            const projects = [
                  ...
                  { imageID: 'SharpClub_Cover_lackww', mobileImageID: 'SharpClub_Cover_Mobile_s5jr9y', alt: 'projects.thesharp_club.images.front', title: 'projects.thesharp_club.title', url: t('projects.thesharp_club.path') },
                  ...
                  { imageID: 'VelvetSoul_Cover_kwfuhi', mobileImageID: 'VelvetSoul_Cover_Mobile_lziohs', alt: 'projects.velvet_soul_street.images.front', title: 'projects.velvet_soul_street.title', url: t('projects.velvet_soul_street.path') },
