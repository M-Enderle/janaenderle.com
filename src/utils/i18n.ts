...
export const ui = {
  en: {
    ...
    // Contact page texts
    'texts.contact.title': 'Contact me',
    'texts.contact.form.name': 'Name',
    'texts.contact.form.email': 'Email',
    'texts.contact.form.message': 'Message',
    'texts.contact.form.submit': 'Send email',
    'texts.contact.form.sending': 'Sending...',
    'texts.contact.form.nameRequired': 'Name is required',
    'texts.contact.form.emailRequired': 'Email is required',
    'texts.contact.form.emailInvalid': 'Please enter a valid email address',
    'texts.contact.form.messageRequired': 'Message is required',
    'texts.contact.form.success': 'Email sent',
    'texts.contact.form.error': 'Failed to send message. Please contact me directly via email.',
    // Project titles
  ...
  de: {
    ...
    // Contact page texts
    'texts.contact.title': 'Kontaktiere mich',
    'texts.contact.form.name': 'Name',
    'texts.contact.form.email': 'E-Mail',
    'texts.contact.form.message': 'Nachricht',
    'texts.contact.form.submit': 'E-Mail senden',
    'texts.contact.form.sending': 'Sende...',
    'texts.contact.form.nameRequired': 'Name ist erforderlich',
    'texts.contact.form.emailRequired': 'E-Mail ist erforderlich',
    'texts.contact.form.emailInvalid': 'Bitte geben Sie eine gültige E-Mail-Adresse ein',
    'texts.contact.form.messageRequired': 'Nachricht ist erforderlich',
    'texts.contact.form.success': 'E-Mail gesendet',
    'texts.contact.form.error': 'Fehler beim Senden der Nachricht. Bitte kontaktieren Sie mich direkt per E-Mail.',
    // Project titles
    'projects.annayuna.title': 'ANNA YUNA',
    'projects.super_me.title': 'Super Me',
    'projects.lenis.title': 'Leni\'s Sweet & Salty',
